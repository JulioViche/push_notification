...
\begin{figure}[H]
    \centering
    % \includegraphics[width=0.5\textwidth]{notification_terminated.png}
    \caption{Notificación Firebase en modo Terminated}
    \label{fig:terminated}
\end{figure}

\textit{Nota: Captura de notificación Firebase recibida con app completamente cerrada}
